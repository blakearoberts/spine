...
(function() {
  ...
  Model = {
    ...
    "delete": function(record, options) {
      ...
      if (record.id) {
        this.fbref.child(record.id).update(null).then(function() {
          console.log('firebase delete record', record.attributes());
          return d_deferred != null ? d_deferred.resolve() : void 0;
        });
      } else {
        this.fbref.update(null).then(function() {
