...
(function() {
  ...
  Firebase = (function(superClass) {
    ...
    Firebase.prototype.initFirebase = function(config) {
      ...
      return firebase.auth().onAuthStateChanged((function(userParams) {
        ...
        return ctr.log('firebase auth error', error);
      });
    };
  ...
  Model = {
    ...
    fetch: function(options) {
      ...
      if (!this.fbref) {
        ...
        if (options != null ? options.child : void 0) {
          this.fbref = this.fbref.child(options.child);
        }
      }
        ...
        return function(data) {
          ...
          if (options != null ? options.child : void 0) {
            ...
            data.forEach(function(child) {
              ...
              if (options != null ? options.where : void 0) {
                ref = options.where;
                results = [];
                for (key in ref) {
                  value = ref[key];
                  if (child.val()[key][value]) {
                    results.push(records.push(child.val()));
                  } else {
                    results.push(void 0);
                  }
                }
          ...
          return console.log('firebase fetch', records);
        };
      })(this));
      return promise;
    },
    fetchOnce: function(options) {
      ...
      this.fbref.once('value', (function(_this) {
        return function(data) {
          ...
          _this.refresh(records || [], options);
          l_deferred.resolve(records);
          return console.log('firebase fetch once', records);
        };
      })(this));
      return promise;
    },
    ...
    update: function(record, options) {
      var i, len, model, promise, ref, tempRef, u_deferred, updates;
      if (record == null) {
        record = {};
      }
      if (options == null) {
      ...
      tempRef = this.fbref;
      if (!(options != null ? options.child : void 0) && (record != null ? record.id : void 0)) {
        tempRef = this.fbref.child(record.id);
      }
      updates = {};
      if (record != null ? record.id : void 0) {
      ...
      tempRef.update(updates).then(function() {
    ...
    "delete": function(record, options) {
      var d_deferred, i, len, model, promise, ref, tempRef, updates;
      if (record == null) {
        record = {};
      }
      if (options == null) {
      ...
      if (!this.fbref) {
        this.fbref = firebase.database().ref(this.ref);
        if (options != null ? options.child : void 0) {
          this.fbref = this.fbref.child(record.id);
        }
      }
      d_deferred = $.Deferred();
      promise = d_deferred.promise();
